...
FINAL_IMAGE=dist/${CND_CONF}/${IMAGE_TYPE}/pic2-16f627a-interrupt.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-default.mk dist/${CND_CONF}/${IMAGE_TYPE}/pic2-16f627a-interrupt.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}

MP_PROCESSOR_OPTION=PIC16F627A
# ------------------------------------------------------------------------------------
